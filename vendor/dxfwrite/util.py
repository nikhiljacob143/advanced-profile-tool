...
# Python 3 only (QGIS >= 3.28); the legacy Python-2 branch was removed
# when vendoring, eliminating Python-2-only name references.
from io import StringIO  # noqa: F401  (part of dxfwrite's public API)
izip = zip
